...
public class ModLootTableProviter extends FabricBlockLootTableProvider {

    public ModLootTableProviter(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
