...
public class ModModelProviter extends FabricModelProvider {
    public ModModelProviter(FabricDataOutput output) {
        super(output);
    }
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(ModItems.BAD_FUEL, Models.GENERATED);
